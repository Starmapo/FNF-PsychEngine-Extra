...
class PlayState extends MusicBeatState
{
	...
	public static var maniaArrangement:Array<String>;
	...
	override public function create()
	{
		...
		switch (playerKeys) {
			...
			case 6:
				singAnimations = ['singLEFT', 'singUP', 'singRIGHT', 'singLEFT', 'singDOWN', 'singRIGHT'];
				keysArray = [
			...
			case 7:
				singAnimations = ['singLEFT', 'singUP', 'singRIGHT', 'singUP', 'singLEFT', 'singDOWN', 'singRIGHT'];
				keysArray = [
					ClientPrefs.copyKey(ClientPrefs.keyBinds.get('note7_left')),
					ClientPrefs.copyKey(ClientPrefs.keyBinds.get('note7_up')),
					ClientPrefs.copyKey(ClientPrefs.keyBinds.get('note7_right')),
			...
			case 8:
				singAnimations = ['singLEFT', 'singDOWN', 'singUP', 'singRIGHT', 'singLEFT', 'singDOWN', 'singUP', 'singRIGHT'];
				keysArray = [
			...
			case 9:
				singAnimations = ['singLEFT', 'singDOWN', 'singUP', 'singRIGHT', 'singUP', 'singLEFT', 'singDOWN', 'singUP', 'singRIGHT'];
				keysArray = [
					ClientPrefs.copyKey(ClientPrefs.keyBinds.get('note9_left')),
					ClientPrefs.copyKey(ClientPrefs.keyBinds.get('note9_down')),
					ClientPrefs.copyKey(ClientPrefs.keyBinds.get('note9_up')),
		...
		switch (opponentKeys) {
			...
			case 6:
				dadSingAnimations = ['singLEFT', 'singUP', 'singRIGHT', 'singLEFT', 'singDOWN', 'singRIGHT'];
			case 7:
				dadSingAnimations = ['singLEFT', 'singUP', 'singRIGHT', 'singUP', 'singLEFT', 'singDOWN', 'singRIGHT'];
			case 8:
				dadSingAnimations = ['singLEFT', 'singDOWN', 'singUP', 'singRIGHT', 'singLEFT', 'singDOWN', 'singUP', 'singRIGHT'];
			case 9:
		...
		if (SONG.arrowSkin == null || SONG.arrowSkin.length < 1) {
			SONG.arrowSkin = 'default';
		}
		uiSkin = UIData.getUIFile(SONG.arrowSkin);
		if (uiSkin == null) {
		...
		#end
			path = 'uiskins/default/timeBar';
		}
		timeBarBG = new AttachedSprite(path);
		...
		if (!Assets.exists(Paths.getPath('images/$path.png', IMAGE))) {
		#end
			path = 'uiskins/default/healthBar';
		}
  ...
  public function clearShaderFromCamera(cam:String){
			...
			startTimer = new FlxTimer().start(modifiedCrochet / 1000, function(tmr:FlxTimer)
			{
				...
				switch (swagCounter)
				{
					...
					case 1:
						...
						if (!Assets.exists(Paths.getPath('images/$path.png', IMAGE))) {
						#end
							path = 'uiskins/default/' + introAlts[0];
						}
						countdownReady = new FlxSprite().loadGraphic(Paths.image(path));
					...
					case 2:
						...
						if (!Assets.exists(Paths.getPath('images/$path.png', IMAGE))) {
						#end
							path = 'uiskins/default/' + introAlts[1];
						}
						countdownSet = new FlxSprite().loadGraphic(Paths.image(path));
					...
					case 3:
						if (!skipCountdown){
							...
							if (!Assets.exists(Paths.getPath('images/$path.png', IMAGE))) {
							#end
								path = 'uiskins/default/' + introAlts[2];
							}
							countdownGo = new FlxSprite().loadGraphic(Paths.image(path));
	...
	private function generateSong(dataPath:String):Void
	{
		...
		{
			case "multiplicative":
				songSpeed = SONG.speed * ClientPrefs.getGameplaySetting('scrollspeed', 1) * (playbackRate * 0.95);
			case "constant":
				songSpeed = ClientPrefs.getGameplaySetting('scrollspeed', 1) * (playbackRate * 0.95);
		}
		...
		for (section in noteData)
		{
			for (songNotes in section.sectionNotes)
			{
				...
				var daNoteData:Int = Std.int(songNotes[1] % SONG.keyAmount);

				var gottaHitNote:Bool = section.mustHitSection;

				if (songNotes[1] >= SONG.keyAmount)
				{
	...
	{
		if(startingSong || endingSong || finishTimer != null) return;
	...
	override public function update(elapsed:Float)
	{
		...
		if (generatedMusic)
		{
			...
			notes.forEachAlive(function(daNote:Note)
			{
				...
				if (daNote.mustPress == opponentChart) {
					strums = opponentStrums;
				}
				strumX = strums.members[daNote.noteData].x;
				strumY = strums.members[daNote.noteData].y;
				strumAngle = strums.members[daNote.noteData].angle;
				strumDirection = strums.members[daNote.noteData].direction;
				strumAlpha = strums.members[daNote.noteData].alpha;
				strumScroll = strums.members[daNote.noteData].downScroll;

				strumX += daNote.offsetX;
				strumY += daNote.offsetY;
				strumAngle += daNote.offsetAngle;
				strumAlpha *= daNote.multAlpha;
				var center:Float = strumY + daNote.height / 2;
	...
	private function popUpScore(note:Note = null):Void
	{
		...
		if (!Assets.exists(Paths.getPath('images/$path.png', IMAGE))) {
		#end
			path = 'uiskins/default/$daRating';
		}

		rating.loadGraphic(Paths.image(path));
		...
		if (!Assets.exists(Paths.getPath('images/$path.png', IMAGE))) {
		#end
			path = 'uiskins/default/combo';
		}

		var comboSpr:FlxSprite = new FlxSprite().loadGraphic(Paths.image(path));
		...
		for (i in seperatedScore)
		{
			...
			if (!Assets.exists(Paths.getPath('images/$path.png', IMAGE))) {
			#end
				path = 'uiskins/default/' + 'num' + Std.int(i);
			}
			var numScore:FlxSprite = new FlxSprite().loadGraphic(Paths.image(path));
	...
	function spawnNoteSplashOnNote(note:Note) {
		if(ClientPrefs.noteSplashes && note != null) {
			...
			if (opponentChart) strum = opponentStrums.members[note.noteData];
			if(strum != null) {
